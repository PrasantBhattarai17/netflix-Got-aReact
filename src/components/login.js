...
const Login = () => {
  ...
  return (
        ...
        <div className='relative   mt-40 flex justify-center min-h-96 '>
           {islogedin? <form  onSubmit={(e)=>e.preventDefault()} className='flex flex-col w-[27%]   justify-center  items-center rounded-md  bg-black bg-opacity-80 gap-y-4' >
           <span className='self-start ml-20 py-2 my-2 text-3xl font-bold text-white'>Sign In</span>
            <input ref={email} className='border-gray-400 border-2 text-white rounded bg-black bg-opacity-70 h-14 p-2 m-2 w-4/6' type='text' placeholder='Email or mobile Number'/>
            <input ref={password} className='border-gray-400 border-2 text-white rounded  bg-black bg-opacity-70 h-14 p-2 m-2 w-4/6' type='password' placeholder='Password'/>
            <p className='text-red-500 font-bold'>{error}</p>
        <button onClick={handleClick} className='border-white border-1  text-white bg-[red] w-4/6 h-[50px] rounded text-lg font-bold hover:bg-red-700'>Sign in</button>
...
<span onClick={handleSign} className='text-white font-bold cursor-pointer hover:underline'>Sign Up now</span>
            ...
            <form  onSubmit={(e)=>e.preventDefault()} className='flex flex-col w-[27%]   justify-center  items-center rounded-md  bg-black bg-opacity-80 gap-y-4' >
           ...
           <input className='border-gray-400 border-2 text-white rounded  bg-black bg-opacity-70 h-14 p-2 m-2 w-4/6' type='text' placeholder='Mobile number'/>
